...
def CustomChartsheetView():
    from ..customchartsheetview import CustomChartsheetView

    return CustomChartsheetView


class TestCustomChartsheetView:
    def test_parse_customChartsheetView(self, CustomChartsheetView):
        src = """
    ...
    def test_serialise_customChartsheetView(self, CustomChartsheetView):
...
def CustomChartsheetViews():
    from ..chartsheet import CustomChartsheetViews

    return CustomChartsheetViews


class TestCustomChartsheetViews:
    def test_read_customChartsheetViews(self, CustomChartsheetViews):
        src = """
        <customSheetViews>
            <customSheetView guid="{C43F44F8-8CE9-4A07-A9A9-0646C7C6B826}" scale="88" zoomToFit="1">
                <pageMargins left="0.23622047244094491" right="0.23622047244094491" top="0.74803149606299213" bottom="0.74803149606299213" header="0.31496062992125984" footer="0.31496062992125984" />
    ...
    def test_serialise_customChartsheetViews(self, CustomChartsheetViews):
        from ..customchartsheetview import CustomChartsheetView
