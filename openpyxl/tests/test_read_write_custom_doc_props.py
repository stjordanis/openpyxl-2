...
def test_read_custom_doc_props(datadir):
    ...
    custom_doc_props_dict = {
        ...
        "PropName2": {'value': datetime.datetime(2020, 8, 24, hour=20, minute=19, second=22)},
        "PropName3": {'value': datetime.datetime(2020, 8, 24, hour=20, minute=19, second=22)},
        "PropName4": {'value': None, 'linkTarget': "ExampleName"},
        "PropName5": {'value': 2.5},
        "PropName6": {'value': 2},
        "PropName7": {'value': 2.5},
        "PropName8": {'value': "Foo"},
        "PropName9": {'value': True},
    }
...
def test_write_custom_doc_props(datadir):
    ...
    wb.custom_doc_props.add("PropName2", "2020-08-24T20:19:22Z", "date")
    wb.custom_doc_props.add("PropName3", "2020-08-24T20:19:22Z", "date")
    wb.custom_doc_props.add("PropName4", LinkTarget="ExampleName")
    wb.custom_doc_props.add("PropName5", 2.5)
    wb.custom_doc_props.add("PropName6", 2)
    wb.custom_doc_props.add("PropName7", "2.5", float)
    wb.custom_doc_props.add("PropName8", "Foo")
    wb.custom_doc_props.add("PropName9", True)
...
def test_read_and_write_custom_doc_props(datadir):
    datadir.join("reader").chdir()
    wb = load_workbook('example_vba_and_custom_doc_props.xlsm')
